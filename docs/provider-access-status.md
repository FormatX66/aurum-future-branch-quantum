...
Status: 2026-08-24 15:14 America/New_York
...
| Azure Quantum | Microsoft identity authenticated; no subscription exists | Subscription/billing decision before workspace or provider creation |
...
| Google Quantum Engine | Cloud project and local Cirq simulator ready; Engine API not entitled | Sponsor/program allowlisting for project `aurum-future-branch-quantum` |
